...
const person = { id: "1", created_at: "2026-01-01T00:00:00.000Z", name: "Ana Martínez", email: "ana@empresa.com", phone: "5512345678", role: "Diseñadora", status: "active" as const };

describe("DeletePersonDialog", () => {
  it("does not call delete when cancellation is chosen", async () => {
    const user = userEvent.setup();
    const onConfirm = vi.fn();
    render(<DeletePersonDialog person={person} open onOpenChange={vi.fn()} onConfirm={onConfirm} />);
